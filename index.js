...
function insertNewRecord(data) {
    ...
    cell5.innerHTML = `<a style="color: #398AB9; text-decoration: none" onClick="onEdit(this)">Edit</a>
                       <a style="color: #398AB9; text-decoration: none" onClick="onDelete(this)">Delete</a>`;
}
